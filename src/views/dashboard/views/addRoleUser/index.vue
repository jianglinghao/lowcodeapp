    ...
    methods: {
        ...
        async roleAddUserReduplicate(inputUserId, inputRoleId) {
            ...
            this.alreadyBindRoleUserList = this.$genInitFromSchema(
                ...
                await this.$logics["app.logics.LCAPGetRoleBindUserList"]({
                    ...
                    query: {},
                    headers: {
                        "lcap-calllogic-uuid": "8080abc0-8adc-42c1-a0e9-bc8436299afe",
                    },
                    path: {},
                    body: {
            ...
            var $forEachListVariable8021 = this.alreadyBindRoleUserList;
            var $forEachStartVariable8021 = 0;
            var $forEachEndVariable8021 = (this.alreadyBindRoleUserList || {}).length;
            if (Array.isArray($forEachListVariable8021)) {
                for (let i = $forEachStartVariable8021; i < $forEachEndVariable8021; i++) {
                    const item = $forEachListVariable8021[i];
                ...
                if (this.$utils["Convert"]((this.input || {}).id, { concept: "TypeAnnotation", typeKind: "primitive", typeNamespace: "nasl.core", typeName: "Boolean", typeArguments: null, returnType: null, properties: null, name: "" })) {
                    this.$genInitFromSchema(
                        ...
                        await this.$logics["app.dataSources.defaultDS.entities.LCAPUserRoleMapping.logics.update"]({
                            ...
                            query: {},
                            headers: {
                                "lcap-calllogic-uuid": "b771475c-5b5b-4391-8246-598095ec78bf",
                            },
                            body: {
                                entity: this.input,
                            },
                    ...
                    this.$genInitFromSchema(
                        ...
                        await this.$logics["app.dataSources.defaultDS.entities.LCAPUserRoleMapping.logics.create"]({
                            ...
                            query: {},
                            headers: {
                                "lcap-calllogic-uuid": "3d5217d0-71e5-4276-8c88-500a34111ff5",
                            },
        ...
        async getUsersListFromNumis() {
            ...
            returnBody = this.$genInitFromSchema(
                ...
                await this.$logics["app.logics.LCAPGetAllUsers"]({
                    ...
                    query: {},
                    headers: {
                        "lcap-calllogic-uuid": "5e88c8ad-73f8-428f-8ab4-86a15773befa",
                    },
                    path: {},
                    body: {},
                })
        ...
        async load(params) {
            ...
            result = this.$genInitFromSchema(
                ...
                await this.$logics["app.logics.LCAPLoadUserRoleMappingTableView"]({
                    ...
                    query: {},
                    headers: {
                        "lcap-calllogic-uuid": "edf8670c-3193-49c1-8a4d-7cbdc5ccfe21",
                    },
                    path: {},
                    body: {
                        page: (params || {}).page,
        ...
        async uButton2_click(event) {
            await (async () => {
                ...
                var $forEachListVariable7648 = this.userIdListBySelect;
                var $forEachStartVariable7648 = 0;
                var $forEachEndVariable7648 = (this.userIdListBySelect || {}).length;
                if (Array.isArray($forEachListVariable7648)) {
                    for (let i = $forEachStartVariable7648; i < $forEachEndVariable7648; i++) {
                        const item = $forEachListVariable7648[i];
                        ...
                        returnOfGetUser = this.$genInitFromSchema(
                            ...
                            await this.$logics["app.logics.LCAPGetUserByUserId"]({
                                ...
                                query: {},
                                headers: {
                                    "lcap-calllogic-uuid": "9e36e349-da85-421e-bc36-792aec037075",
                                },
                                path: {},
                                body: {
                                    userId: item,
                        ...
                        if (isDuplicateUserId == true) {
                            ...
                            this.$genInitFromSchema(
                                ...
                                await this.$logics["app.dataSources.defaultDS.entities.LCAPUserRoleMapping.logics.create"]({
                                    ...
                                    query: {},
                                    headers: {
                                        "lcap-calllogic-uuid": "7d8c16d0-7a71-494a-ab91-679629188058",
                                    },
        ...
        async uLink1_click(event, current) {
            await (async () => {
                await this.$logics["app.dataSources.defaultDS.entities.LCAPUserRoleMapping.logics.delete"]({
                    ...
                    query: {},
                    headers: {
                        "lcap-calllogic-uuid": "95174858-9e0a-439c-933c-72fa0d71cc39",
                    },
                    query: {
